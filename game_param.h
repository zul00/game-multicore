...
extern CFifo<enemy_param_t,CFifo<>::w> *wr_enemy_c;
extern CFifo<enemy_param_t,CFifo<>::r> *rd_enemy_c;
...
extern CFifo<bullet_param_t,CFifo<>::w> *wr_bullet_c;
extern CFifo<bullet_param_t,CFifo<>::r> *rd_bullet_c;
